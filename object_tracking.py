...
def segment_and_characterization(cap: cv2.VideoCapture, imagen: str) -> None:
    ...
    while cap.isOpened():
        ...
        # Dibujar una línea verde vertical en el centro del video
        ...
        start_time, left_time, right_time, left_to_right, right_to_left = crossCounting_and_time(centroid_x, frame, start_time, left_time, right_time, left_to_right, right_to_left)
...
def crossCounting_and_time(centroid_x, frame, start_time, left_time, right_time, left_to_right, right_to_left):
    """
    ...
    """
    # Obtenemos el centro del eje X del video que nos servira de referencia para nuestro centroide
    line_position = frame.shape[1] // 2

    # Centroide a la derecha
    if centroid_x > line_position:
